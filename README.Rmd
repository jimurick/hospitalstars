...
This has only been tested on Windows. The steps to install on Windows are
...
In order to calculate star ratings, you need an input table with all hospitals' data. The `star_rating_input()` function returns a data.frame made of Care Compare data from the `report_date`, the first day of the month the Care Compare report was released.
